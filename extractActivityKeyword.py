...
플래너의 이름과 설명에서 할 수 있는 활동 키워드는 뭔가요?
...
#     # 목표 키워드 추출
#     activity_keyword = extract_activity_chain.invoke({
#         'name': planner_name,
#         'desc': planner_desc,
#     })
#
